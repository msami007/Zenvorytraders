      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="border border-gray-300 rounded-md p-2 focus:ring-2 focus:ring-[#367588]"
          >
        ...
        <div className="relative w-full md:w-1/3">
          <input
            ...
            className="w-full border border-gray-300 rounded-md p-2 pl-4 pr-10 focus:outline-none focus:ring-2 focus:ring-[#367588]"
          />
          <svg
        ...
        <>
          ...
          {filteredProducts.map((product) => (
            ...
            >
              ...
              {/* Name */}
              <div
                className="md:col-span-3 text-gray-800 cursor-pointer hover:text-[#367588]"
                onClick={() => navigate(`/product/${product.sku}`)}
              >
              ...
              <div className="md:col-span-2 text-left md:text-center">
                ...
                <input
                  ...
                  className="w-24 md:w-16 text-center border border-gray-300 rounded-md p-1 focus:ring-1 focus:ring-[#367588]"
                />
              </div>
              ...
              <div className="md:col-span-2 text-left md:text-center">
                ...
                <button
                  ...
                  className="mt-1 md:mt-0 bg-[#367588] text-white px-4 py-2 rounded hover:bg-[#2c5d6a] transition"
                >
                  Add to cart
                </button>
              </div>
