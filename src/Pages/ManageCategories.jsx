...
export default function ManageCategories() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const endpoint = formData.id 
                ? 'https://zenvorytradersllc.com/api/update_category.php'
                : 'https://zenvorytradersllc.com/api/add_category.php';
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const response = await fetch('https://zenvorytradersllc.com/api/delete_category.php', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json'
                },
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex justify-between items-center mb-6">
                    ...
                    <button
                        ...
                        className="bg-[#367588] text-white px-4 py-2 rounded-md hover:bg-gray-800"
                    >
                        Add New Category
                    </button>
                </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[#367588] focus:ring-[#367588] sm:text-sm"
                                    required
                                />
                            </div>
                            ...
                            <div className="flex justify-end gap-4 mt-5">
                                ...
                                <button
                                    type="submit"
                                    className="px-4 py-2 text-sm font-medium text-white bg-[#367588] hover:bg-gray-800 rounded-md"
                                >
